  ...
  return (
    <div className="w-full max-w-sm">
      <div className="rounded-2xl border border-ink-700 bg-ink-900/80 p-8 shadow-[0_0_0_1px_rgba(0,0,0,0.4),0_24px_60px_-24px_rgba(0,0,0,0.8)] backdrop-blur-sm">
        ...
        <p className="mt-1 text-[13px] text-ink-500">Acesse o dashboard de valuation</p>

        <form onSubmit={handleSubmit} className="mt-7 space-y-4">
          <div>
            <label className="block text-[11px] font-medium uppercase tracking-wider text-ink-500" htmlFor="usuario">
              Usuário
            </label>
            <input
              id="usuario"
          ...
          <div>
            <label className="block text-[11px] font-medium uppercase tracking-wider text-ink-500" htmlFor="senha">
              Senha
            </label>
            <input
              id="senha"
        ...
        <div className="mt-6 rounded-lg border border-ink-700 bg-black/40 px-3.5 py-2.5 text-[12px] text-ink-500">
