        ...
        <AreaChart data={dados} margin={{ top: 4, right: 12, left: 4, bottom: 0 }}>
          <defs>
            <linearGradient id="fcffFill" x1="0" y1="0" x2="0" y2="1">
              <stop offset="0%" stopColor="#4aa2ee" stopOpacity={0.35} />
              <stop offset="100%" stopColor="#4aa2ee" stopOpacity={0.02} />
            </linearGradient>
          </defs>
          ...
          <Area type="monotone" dataKey="fcff" stroke="#4aa2ee" strokeWidth={2} fill="url(#fcffFill)" />
        </AreaChart>
      </ResponsiveContainer>
